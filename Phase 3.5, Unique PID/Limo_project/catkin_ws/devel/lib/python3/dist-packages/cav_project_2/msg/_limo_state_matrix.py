...
"""autogenerated by genpy from cav_project_2/limo_state_matrix.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['limos']
  _slot_types = ['cav_project_2/limo_state[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = cav_project_2.msg.limo_state()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
