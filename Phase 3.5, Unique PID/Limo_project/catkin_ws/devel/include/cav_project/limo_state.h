...
struct limo_state_
{
  ...
  _d3_type d3;
   ...
   typedef double _v3_type;
  _v3_type v3;

   typedef double _l3_type;
  _l3_type l3;
...
struct MD5Sum< ::cav_project::limo_state_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xda7b3f6ffbb46c2fULL;
  static const uint64_t static_value2 = 0x328a77f102c44e10ULL;
};
...
struct Printer< ::cav_project::limo_state_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cav_project::limo_state_<ContainerAllocator>& v)
  {
    ...
    s << indent << "v3: ";
    Printer<double>::stream(s, indent + "  ", v.v3);
    s << indent << "l3: ";
    Printer<double>::stream(s, indent + "  ", v.l3);
    s << indent << "vd: ";
