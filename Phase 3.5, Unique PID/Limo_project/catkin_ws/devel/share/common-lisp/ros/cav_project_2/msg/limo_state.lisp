...
(cl:defmethod cl:initialize-instance :after ((m <limo_state>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'limo_state)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cav_project_2-msg:<limo_state> is deprecated: use cav_project_2-msg:limo_state instead.")))

(cl:ensure-generic-function 'limoID-val :lambda-list '(m))
(cl:defmethod limoID-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:limoID-val is deprecated.  Use cav_project_2-msg:limoID instead.")
  (limoID m))

(cl:ensure-generic-function 'vel-val :lambda-list '(m))
(cl:defmethod vel-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:vel-val is deprecated.  Use cav_project_2-msg:vel instead.")
  (vel m))

(cl:ensure-generic-function 'd0-val :lambda-list '(m))
(cl:defmethod d0-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:d0-val is deprecated.  Use cav_project_2-msg:d0 instead.")
  (d0 m))

(cl:ensure-generic-function 'd1-val :lambda-list '(m))
(cl:defmethod d1-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:d1-val is deprecated.  Use cav_project_2-msg:d1 instead.")
  (d1 m))

(cl:ensure-generic-function 'v1-val :lambda-list '(m))
(cl:defmethod v1-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:v1-val is deprecated.  Use cav_project_2-msg:v1 instead.")
  (v1 m))

(cl:ensure-generic-function 'd2-val :lambda-list '(m))
(cl:defmethod d2-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:d2-val is deprecated.  Use cav_project_2-msg:d2 instead.")
  (d2 m))

(cl:ensure-generic-function 'v2-val :lambda-list '(m))
(cl:defmethod v2-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:v2-val is deprecated.  Use cav_project_2-msg:v2 instead.")
  (v2 m))

(cl:ensure-generic-function 'vd-val :lambda-list '(m))
(cl:defmethod vd-val ((m <limo_state>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:vd-val is deprecated.  Use cav_project_2-msg:vd instead.")
  (vd m))
