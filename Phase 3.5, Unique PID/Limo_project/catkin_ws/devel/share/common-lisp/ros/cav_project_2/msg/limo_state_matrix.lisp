...
(cl:defclass <limo_state_matrix> (roslisp-msg-protocol:ros-message)
  ((limos
    :reader limos
    :initarg :limos
    :type (cl:vector cav_project_2-msg:limo_state)
   :initform (cl:make-array 0 :element-type 'cav_project_2-msg:limo_state :initial-element (cl:make-instance 'cav_project_2-msg:limo_state))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <limo_state_matrix>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'limo_state_matrix)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cav_project_2-msg:<limo_state_matrix> is deprecated: use cav_project_2-msg:limo_state_matrix instead.")))

(cl:ensure-generic-function 'limos-val :lambda-list '(m))
(cl:defmethod limos-val ((m <limo_state_matrix>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:limos-val is deprecated.  Use cav_project_2-msg:limos instead.")
  (limos m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <limo_state_matrix>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'limos)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'cav_project_2-msg:limo_state))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<limo_state_matrix>)))
  ...
  "cav_project_2/limo_state_matrix")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'limo_state_matrix)))
  "Returns string type for a message object of type 'limo_state_matrix"
  "cav_project_2/limo_state_matrix")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<limo_state_matrix>)))
  ...
  (cl:format cl:nil "limo_state[] limos~%~%================================================================================~%MSG: cav_project_2/limo_state~%string limoID~%float64 vel~%float64 d0~%float64 d1~%float64 v1~%float64 d2~%float64 v2~%float64 vd~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'limo_state_matrix)))
  "Returns full string definition for message of type 'limo_state_matrix"
  (cl:format cl:nil "limo_state[] limos~%~%================================================================================~%MSG: cav_project_2/limo_state~%string limoID~%float64 vel~%float64 d0~%float64 d1~%float64 v1~%float64 d2~%float64 v2~%float64 vd~%~%~%"))
