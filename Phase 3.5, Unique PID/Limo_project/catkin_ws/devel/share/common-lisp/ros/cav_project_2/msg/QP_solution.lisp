...
(cl:defmethod cl:initialize-instance :after ((m <QP_solution>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QP_solution)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cav_project_2-msg:<QP_solution> is deprecated: use cav_project_2-msg:QP_solution instead.")))

(cl:ensure-generic-function 'u-val :lambda-list '(m))
(cl:defmethod u-val ((m <QP_solution>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_project_2-msg:u-val is deprecated.  Use cav_project_2-msg:u instead.")
  (u m))
