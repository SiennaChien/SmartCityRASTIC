...
(cl:defmethod cl:initialize-instance :after ((m <limo_info>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'limo_info)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cav_project_2-msg:<limo_info> is deprecated: use cav_project_2-msg:limo_info instead.")))
