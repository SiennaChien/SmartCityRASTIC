...
class QPSolverCAV7:
    def __init__(self, cav7_id, cav6_id, cav8_id, cav9_id):
        #self.cav4_id = cav4_id  # CAV4 with the solver (second lateral)
        self.cav9_id = cav9_id  # CAV2 preceding CAV1 (rear-end constraint)s
        self.cav8_id = cav8_id  # receeding
        self.cav7_id = cav7_id  # CAV3 for firstlateral constraint
...
if __name__ == '__main__':
    solver = QPSolverCAV7("limo813", "limo780", "limo777", "limo793")
    solver.run()
