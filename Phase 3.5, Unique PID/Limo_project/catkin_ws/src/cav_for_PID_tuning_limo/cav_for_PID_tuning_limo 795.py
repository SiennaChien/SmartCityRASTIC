...
class CAV():
    ...
    def generate_map(self, isMain, enter):
        ...
        self.path_G1_PID = (0.0003, 0.00008, 0.001)
        self.path_G2_PID = (0.0003, 0.00008, 0.001)
        self.path_G3_PID = (0.0003, 0.00009, 0.001)

        self.path_H1_PID = (0.0003, 0.00008, 0.001)
        self.path_H2_PID = (0.0003, 0.00008, 0.001)
        self.path_H3_PID = (0.0003, 0.00009, 0.001)

        self.path_I1_PID = (-0.001, -0.00009, -0.001)
        self.path_I2_PID = (-0.002, -0.00015, -0.001)
        self.path_I3_PID = (-0.001, -0.00009, -0.001)
        
        self.path_J1_PID = (0.001, 0.00009, 0.001)
        self.path_J2_PID = (0.001, 0.00012, 0.001)
        self.path_J3_PID = (0.001, 0.00009, 0.001)
