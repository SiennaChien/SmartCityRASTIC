...
class QPSolverCAV2:
    def __init__(self, cav2_id, cav3_id, cav1_id, cav4_id, cav5_id, cav6_id, cav7_id, cav8_id, cav9_id, cav10_id, cav11_id):
        self.cav2_id = cav2_id  # CAV2 with the solver (first lateral)
        self.cav3_id = cav3_id  # CAV3 preceding
        self.cav1_id = cav1_id  # Receding
        self.cav4_id = cav4_id  # CAV4 for second lateral constraint
...
if __name__ == '__main__':
    solver = QPSolverCAV2("limo155", "limo795", "limo770", "limo789", "limo799", "limo780", "limo813", "limo777", "limo793", "limo808", "limo787")
    solver.run()
