...
class QPSolverCAV4:
    def __init__(self, cav4_id, cav3_id, cav2_id, cav1_id, cav5_id, cav6_id, cav7_id, cav8_id, cav9_id, cav10_id, cav11_id):
        self.cav4_id = cav4_id  # CAV4 with the solver (first lateral)
        self.cav3_id = cav3_id  # CAV3 preceding CAV4 (rear-end constraint)
...
if __name__ == '__main__':
    solver = QPSolverCAV4("limo789", "limo795", "limo155", "limo770", "limo799", "limo780", "limo813", "limo777", "limo793", "limo808", "limo787")
    solver.run()
