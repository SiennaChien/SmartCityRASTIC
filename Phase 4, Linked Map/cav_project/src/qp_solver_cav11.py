...
class QPSolverCAV11:
    def __init__(self, cav11_id, cav10_id, cav9_id, cav8_id, cav7_id, cav6_id, cav5_id, cav4_id, cav3_id, cav2_id, cav1_id):
        self.cav11_id = cav11_id  # CAV11 with the solver (first lateral)
        self.cav10_id = cav10_id  # CAV10 preceding CAV11 (rear-end constraint)
        self.cav9_id = cav9_id  # Receding
        self.cav8_id = cav8_id  # Receding
        ...
        rospy.init_node("qp_solver_" + self.cav11_id)
        self.qp_solution_pub = rospy.Publisher('/qp_solution_' + self.cav11_id, QP_solution, queue_size=10)
    ...
    def recalc_qp(self):
        if self.state is not None:
            ...
            qp_solution_msg.u = u
            print("Computed control input u qp 11:", u)
...
if __name__ == '__main__':
    solver = QPSolverCAV11("limo787", "limo808", "limo793", "limo777", "limo813", "limo780", "limo799", "limo789", "limo795", "limo155", "limo770")
    solver.run()
