...
class QPSolverCAV5:
    def __init__(self, cav5_id, cav4_id, cav3_id, cav2_id, cav1_id, cav6_id, cav7_id, cav8_id, cav9_id, cav10_id, cav11_id):
        self.cav5_id = cav5_id  # CAV5 with the solver (first lateral)
        self.cav4_id = cav4_id  # CAV4 preceding CAV5 (rear-end constraint)
        self.cav3_id = cav3_id  # Receding
        self.cav2_id = cav2_id  # Receding
        self.cav1_id = cav1_id  # Receding
        self.cav6_id = cav6_id
        self.cav7_id = cav7_id
        ...
        rospy.init_node("qp_solver_" + self.cav5_id)
        self.qp_solution_pub = rospy.Publisher('/qp_solution_' + self.cav5_id, QP_solution, queue_size=10)
    ...
    def recalc_qp(self):
        if self.state is not None:
            ...
            qp_solution_msg.u = u
            print("Computed control input u qp 5:", u)
...
if __name__ == '__main__':
    solver = QPSolverCAV5("limo799", "limo789", "limo795", "limo155", "limo770", "limo780", "limo813", "limo777", "limo793", "limo808", "limo787")
    solver.run()
