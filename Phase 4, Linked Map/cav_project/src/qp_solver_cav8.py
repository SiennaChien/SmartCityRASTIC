...
class QPSolverCAV8:
    def __init__(self, cav8_id, cav7_id, cav6_id, cav5_id, cav4_id, cav3_id, cav2_id, cav1_id, cav9_id, cav10_id, cav11_id):
        self.cav8_id = cav8_id  # CAV8 with the solver (first lateral)
        self.cav7_id = cav7_id  # CAV7 preceding CAV8 (rear-end constraint)
        ...
        rospy.init_node("qp_solver_" + self.cav8_id)
        self.qp_solution_pub = rospy.Publisher('/qp_solution_' + self.cav8_id, QP_solution, queue_size=10)
    ...
    def recalc_qp(self):
        if self.state is not None:
            ...
            qp_solution_msg.u = u
            print("Computed control input u qp 8:", u)
...
if __name__ == '__main__':
    solver = QPSolverCAV8("limo777", "limo813", "limo780", "limo799", "limo789", "limo795", "limo155", "limo770", "limo793", "limo808", "limo787")
    solver.run()
