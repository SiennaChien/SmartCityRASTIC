...
class QPSolverCAV1:
    def __init__(self, cav1_id, cav2_id, cav3_id, cav4_id, cav5_id, cav6_id, cav7_id, cav8_id, cav9_id, cav10_id, cav11_id):
        self.cav1_id = cav1_id  # CAV1 with the solver
        self.cav2_id = cav2_id  # CAV2 preceding CAV1 (rear-end constraint)
        self.cav3_id = cav3_id  # CAV3 for first lateral constraint
...
if __name__ == '__main__':
    solver = QPSolverCAV1("limo770", "limo155", "limo795", "limo789", "limo799", "limo780", "limo813", "limo777", "limo793", "limo808", "limo787")
    solver.run()
