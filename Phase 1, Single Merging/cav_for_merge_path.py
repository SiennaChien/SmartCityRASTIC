...
class CAV():         
   #initialize the CAV
    def __init__(self, node_name):
        ...
        #construct node, publisher, and subscriber
    ...
    #function to generate a virtual map for each CAV
    #creates lines for each lane, then connects the lines together to form the path for the limos to follow
