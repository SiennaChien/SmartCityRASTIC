...
class QPSolverCAV1:
    def __init__(self):
        ...
        self.cav_info_sub = rospy.Subscriber('/cav_info_cav1', limo_info, self.cav_info_callback)
        self.other_cav_info_sub = rospy.Subscriber('/other_cav_info_cav1', limo_info_array, self.other_cav_info_callback)
        self.cav_info = None
