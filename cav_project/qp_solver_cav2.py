...
class QPSolverCAV2:
    def __init__(self):
        rospy.init_node("QP_solver_cav2")
        self.qp_solution_pub = rospy.Publisher('/qp_solution_cav2', QP_solution, queue_size=10)
        self.cav_info_sub = rospy.Subscriber('/cav_info_cav2', limo_info, self.cav_info_callback)
        self.other_cav_info_sub = rospy.Subscriber('/other_cav_info_cav2', limo_info_array, self.other_cav_info_callback)
        self.cav_info = None
