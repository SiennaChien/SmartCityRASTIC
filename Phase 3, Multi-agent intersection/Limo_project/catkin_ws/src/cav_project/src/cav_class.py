...
class CAV:
    def __init__(self, ID, isMain, enter, exit =0):
        self.ID = ID
    ...
    def generate_map(self, isMain, enter, exit):
        ...
        self.path_G_PID = (-0.0004, -0.00012, -0.002)
        self.path_H_PID = (0.0002, 0.0002, 0.001)
        self.path_I_PID = (0.0002, 0.0001, 0.001)
        self.path_J_PID = (-0.0002, -0.0001, -0.001)
