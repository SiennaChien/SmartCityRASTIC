...
class QPSolverCAV2:
    def __init__(self, ID, otherID, isMain):
        ...
        self.cav_pose = None
        self.merging_pt_x = 1950  # Define merging point x-coordinate (in mm)
        self.merging_pt_y = -652  # Define merging point y-coordinate (in mm)
    ...
    def solve_qp(self):
        ...
        eps = 10
        psc = 0.1
        t = rospy.get_time()  # You may adjust this for discrete time steps
        ...
        def solveQP():
            ...
            for row_index, row in enumerate(matrix_const):
                ...
                d2 = np.sqrt((self.position_x - self.merging_pt_x)**2 + (self.position_y - self.merging_pt_y)**2)  # Correct d2 calculation
                L = 3500
                v0 = row[2]
...
if __name__ == '__main__':
    solver = QPSolverCAV2('limo155', 'limo770', True)
